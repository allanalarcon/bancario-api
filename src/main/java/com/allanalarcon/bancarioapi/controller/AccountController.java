...
public class AccountController {
	...
	public List<AccountDto> list(@RequestParam(required = false) String number){
		return number == null ? accountService.findAll() :  accountService.findByNumberContaining(number);
	}
